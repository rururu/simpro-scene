...
var map__15444 = view;
var map__15444__$1 = (((((!((map__15444 == null))))?(((((map__15444.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15444.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15444):map__15444);
var longitude = cljs.core.get.call(null,map__15444__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var latitude = cljs.core.get.call(null,map__15444__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var height = cljs.core.get.call(null,map__15444__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var heading = cljs.core.get.call(null,map__15444__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var pitch = cljs.core.get.call(null,map__15444__$1,new cljs.core.Keyword(null,"pitch","pitch",1495126700));
var roll = cljs.core.get.call(null,map__15444__$1,new cljs.core.Keyword(null,"roll","roll",11266999));
...
cesium.client.VIEWER.homeButton.viewModel.command.beforeExecute.addEventListener(((function (map__15444,map__15444__$1,longitude,latitude,height,heading,pitch,roll,fvw){
return (function (e){
e.cancel = true;

return camera.flyTo(cesium.client.HOME_VIEW);
});})(map__15444,map__15444__$1,longitude,latitude,height,heading,pitch,roll,fvw))
);

return camera.flyTo(cesium.client.HOME_VIEW);
});
cesium.client.clock_settings = (function cesium$client$clock_settings(clock,settings,viewer){
var map__15446 = settings;
...
var animate = cljs.core.get.call(null,map__15446__$1,new cljs.core.Keyword(null,"animate","animate",1850194573));
var start = cljs.core.get.call(null,map__15446__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var stop = cljs.core.get.call(null,map__15446__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
var current = cljs.core.get.call(null,map__15446__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var mult = cljs.core.get.call(null,map__15446__$1,new cljs.core.Keyword(null,"mult","mult",1466794774));
...
var promise = (function (){var pred__15448 = cljs.core._EQ_;
var expr__15449 = format;
if(cljs.core.truth_(pred__15448.call(null,new cljs.core.Keyword(null,"GeoJSON","GeoJSON",33508860),expr__15449))){
return Cesium.GeoJsonDataSource.load(source,options);
} else {
if(cljs.core.truth_(pred__15448.call(null,new cljs.core.Keyword(null,"CZML","CZML",-1539311408),expr__15449))){
return Cesium.CzmlDataSource.load(source,options);
} else {
if(cljs.core.truth_(pred__15448.call(null,new cljs.core.Keyword(null,"KML","KML",1829561453),expr__15449))){
return Cesium.KmlDataSource.load(source,options);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__15449)].join('')));
}
}
}
})();
...
cesium.client.azimuths_AMPERSAND_points = (function cesium$client$azimuths_AMPERSAND_points(p__15452,radr,hgt,N){
var vec__15453 = p__15452;
var c_lambda = cljs.core.nth.call(null,vec__15453,(0),null);
var c_phi = cljs.core.nth.call(null,vec__15453,(1),null);
var s = ((Math.PI * (2)) / N);
var azs = cljs.core.range.call(null,(0),(N * s),s);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [azs,cljs.core.vec.call(null,cljs.core.map.call(null,((function (s,azs,vec__15453,c_lambda,c_phi){
return (function (p1__15451_SHARP_){
return cljs.core.concat.call(null,cesium.client.position_js.call(null,c_lambda,c_phi,radr,p1__15451_SHARP_),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [hgt], null));
});})(s,azs,vec__15453,c_lambda,c_phi))
,azs))], null);
});
...
var vec__15456 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cmp__$1.longitude,cmp__$1.latitude,cmp__$1.height], null);
var lam = cljs.core.nth.call(null,vec__15456,(0),null);
var phi = cljs.core.nth.call(null,vec__15456,(1),null);
var hgt = cljs.core.nth.call(null,vec__15456,(2),null);
var az = camera.heading;
var c = ((((dist_m / (1852)) / (60)) / (180)) * Math.PI);
var vec__15459 = cesium.client.position_js.call(null,lam,phi,c,az);
var lam2 = cljs.core.nth.call(null,vec__15459,(0),null);
var phi2 = cljs.core.nth.call(null,vec__15459,(1),null);
...
return (function (){
var pred__15465 = cljs.core._EQ_;
var expr__15466 = cljs.core.deref.call(null,cesium.client.ORBIT).call(null,new cljs.core.Keyword(null,"status","status",-1997798413));
if(cljs.core.truth_(pred__15465.call(null,new cljs.core.Keyword(null,"init","init",-1875481434),expr__15466))){
...
if(cljs.core.truth_(pred__15465.call(null,new cljs.core.Keyword(null,"stop","stop",-2140911342),expr__15466))){
...
var vec__15468 = cesium.client.look_at.call(null,camera,radm);
var lam = cljs.core.nth.call(null,vec__15468,(0),null);
var phi = cljs.core.nth.call(null,vec__15468,(1),null);
var hgt = cljs.core.nth.call(null,vec__15468,(2),null);
var look = vec__15468;
var vec__15471 = cesium.client.azimuths_AMPERSAND_points.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lam,phi], null),radr,hgt,steps);
var azs = cljs.core.nth.call(null,vec__15471,(0),null);
var pts = cljs.core.nth.call(null,vec__15471,(1),null);
var ring = cljs.core.vec.call(null,cljs.core.map.call(null,((function (steps,radm,radr,vec__15468,lam,phi,hgt,look,vec__15471,azs,pts,pred__15465,expr__15466,obut){
return (function (p1__15463_SHARP_){
return Cesium.Cartesian3.fromRadians(cljs.core.first.call(null,p1__15463_SHARP_),cljs.core.second.call(null,p1__15463_SHARP_),cljs.core.nth.call(null,p1__15463_SHARP_,(2)));
});})(steps,radm,radr,vec__15468,lam,phi,hgt,look,vec__15471,azs,pts,pred__15465,expr__15466,obut))
,pts));
var headings = cljs.core.vec.call(null,cljs.core.map.call(null,((function (steps,radm,radr,vec__15468,lam,phi,hgt,look,vec__15471,azs,pts,ring,pred__15465,expr__15466,obut){
return (function (p1__15464_SHARP_){
return cesium.client.normaz.call(null,(p1__15464_SHARP_ + Math.PI));
});})(steps,radm,radr,vec__15468,lam,phi,hgt,look,vec__15471,azs,pts,ring,pred__15465,expr__15466,obut))
,azs));
...
if(cljs.core.truth_(pred__15465.call(null,new cljs.core.Keyword(null,"run","run",-1821166653),expr__15466))){
camera.cancelFlight();

return cljs.core._vreset_BANG_.call(null,cesium.client.ORBIT,cljs.core.assoc.call(null,cljs.core._deref.call(null,cesium.client.ORBIT),new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"stop","stop",-2140911342)));
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__15466)].join('')));
}
}
}
});})(obut))
