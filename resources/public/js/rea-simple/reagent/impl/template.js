...
var G__3812 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__3812,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__3816 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__3816,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var args = null;
if (arguments.length > 0) {
var G__3818__i = 0, G__3818__a = new Array(arguments.length -  0);
while (G__3818__i < G__3818__a.length) {G__3818__a[G__3818__i] = arguments[G__3818__i + 0]; ++G__3818__i;}
  args = new cljs.core.IndexedSeq(G__3818__a,0,null);
} 
return G__3817__delegate.call(this,args);};
G__3817.cljs$lang$maxFixedArity = 0;
G__3817.cljs$lang$applyTo = (function (arglist__3819){
var args = cljs.core.seq(arglist__3819);
return G__3817__delegate(args);
});
...
var G__3820 = props;
var G__3820__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__3820,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__3820);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__3820__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__3821 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__3821,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__3821;
}
})(),id_class);
...
var G__3822 = (cljs.core.count.call(null,argv) - first_child);
switch (G__3822) {
case (0):
...
var vec__3824 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__3824,(0),null);
var id = cljs.core.nth.call(null,vec__3824,(1),null);
var className = cljs.core.nth.call(null,vec__3824,(2),null);
...
var temp__5808__auto___3827 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___3827 == null)){
} else {
var key_3828 = temp__5808__auto___3827;
(jsprops.key = key_3828);
}
...
var temp__5808__auto___3829 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___3829 == null)){
} else {
var key_3830 = temp__5808__auto___3829;
(jsprops.key = key_3830);
}
...
var temp__5808__auto___3831 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5808__auto___3831 == null)){
} else {
var key_3832 = temp__5808__auto___3831;
(jsprops.key = key_3832);
}
...
var temp__5808__auto___3833 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___3833 == null)){
} else {
var key_3834 = temp__5808__auto___3833;
...
var temp__5808__auto___3835 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___3835 == null)){
} else {
var key_3836 = temp__5808__auto___3835;
(jsprops.key = key_3836);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__3837_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__3837_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__3838 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__3838,(0),null);
var derefed = cljs.core.nth.call(null,vec__3838,(1),null);
...
break;
default:
var G__3843 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__3844 = compiler;
v = G__3843;
compiler = G__3844;
continue;
...
var G__3845 = tag;
var G__3845__$1 = (((G__3845 instanceof cljs.core.Keyword))?G__3845.fqn:null);
switch (G__3845__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template3848 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template3848 = (function (opts,id,fn_to_element,parse_fn,meta3849){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta3849 = meta3849;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template3848.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_3850,meta3849__$1){
var self__ = this;
var _3850__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template3848(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta3849__$1));
}));

(reagent.impl.template.t_reagent$impl$template3848.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_3850){
var self__ = this;
var _3850__$1 = this;
return self__.meta3849;
}));

(reagent.impl.template.t_reagent$impl$template3848.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template3848.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template3848.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template3848.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template3848.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template3848.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta3849","meta3849",-574009172,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template3848.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template3848.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template3848");

(reagent.impl.template.t_reagent$impl$template3848.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write.call(null,writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template3848");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template3848.
 */
reagent.impl.template.__GT_t_reagent$impl$template3848 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template3848(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta3849){
return (new reagent.impl.template.t_reagent$impl$template3848(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta3849));
});

}

return (new reagent.impl.template.t_reagent$impl$template3848(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
