...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__4287 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4287,ch);
...
if(("\\" === ch__$1)){
var ch_4288__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_4288__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_4288__$2);
} else {
}

var G__4289 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__4289;
continue;
}
}
...
var vec__4297 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4297,(0),null);
var start_column = cljs.core.nth.call(null,vec__4297,(1),null);
...
var G__4300 = cljs.core.conj_BANG_.call(null,a,form);
a = G__4300;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__4301 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__4302 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__4302);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__4301);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__4303 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4303,(0),null);
var start_column = cljs.core.nth.call(null,vec__4303,(1),null);
...
var vec__4306 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4306,(0),null);
var end_column = cljs.core.nth.call(null,vec__4306,(1),null);
...
var vec__4309 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4309,(0),null);
var start_column = cljs.core.nth.call(null,vec__4309,(1),null);
...
var vec__4312 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4312,(0),null);
var end_column = cljs.core.nth.call(null,vec__4312,(1),null);
...
var vec__4315 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4315,(0),null);
var start_column = cljs.core.nth.call(null,vec__4315,(1),null);
...
var vec__4318 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4318,(0),null);
var end_column = cljs.core.nth.call(null,vec__4318,(1),null);
...
var sb = (function (){var G__4321 = (new goog.string.StringBuffer());
G__4321.append(initch);
...
var G__4323 = (function (){var G__4322 = sb;
G__4322.append(ch);

return G__4322;
})();
var G__4324 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__4323;
ch = G__4324;
continue;
}
...
switch (G__4327) {
case "\\":
var G__4331 = (function (){var G__4328 = sb;
G__4328.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__4328;
})();
var G__4332 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4331;
ch = G__4332;
continue;
...
break;
default:
var G__4333 = (function (){var G__4329 = sb;
G__4329.append(ch);

return G__4329;
})();
var G__4334 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4333;
ch = G__4334;
continue;
...
var vec__4335 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4335,(0),null);
var end_column = cljs.core.nth.call(null,vec__4335,(1),null);
...
var vec__4338 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4338,(0),null);
var column = cljs.core.nth.call(null,vec__4338,(1),null);
...
var vec__4343 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4343,(0),null);
var column = cljs.core.nth.call(null,vec__4343,(1),null);
...
var vec__4348 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4348,(0),null);
var column = cljs.core.nth.call(null,vec__4348,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__4353 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4353,(0),null);
var start_column = cljs.core.nth.call(null,vec__4353,(1),null);
...
var vec__4356 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4356,(0),null);
var end_column = cljs.core.nth.call(null,vec__4356,(1),null);
...
var G__4359 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__4359,true,null,opts,pending_forms);
...
var G__4360 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__4360)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__4360)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__4360)){
...
var _STAR_suppress_read_STAR__orig_val__4361 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__4362 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__4362);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__4361);
}});
...
var G__4363 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__4363,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__4363,rdr,first_line);
...
var G__4367 = matched;
var G__4368 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__4367;
finished = G__4368;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__4369 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__4370 = (function (){var or__5045__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__4370);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__4369);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__4371 = cljs.tools.reader.arg_env;
var arg_env_temp_val__4372 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__4372);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__4373 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4373,"(");
...
var G__4374 = (i + (1));
var G__4375 = cljs.core.conj_BANG_.call(null,args,(function (){var or__5045__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__4371);
}});
/**
...
var ch = temp__5802__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__4376 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__4376);
...
var G__4379 = cljs.core.next.call(null,s);
var G__4380 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__4379;
key_vals = G__4380;
continue;
} else {
...
var gensym_env_orig_val__4383 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__4384 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__4384);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__4383);
}});
cljs.tools.reader.read_namespaced_map = (function cljs$tools$reader$read_namespaced_map(rdr,_,opts,pending_forms){
var vec__4385 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4385,(0),null);
var start_column = cljs.core.nth.call(null,vec__4385,(1),null);
...
var temp__5802__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__4388 = token;
var G__4388__$1 = (((G__4388 == null))?null:cljs.core.subs.call(null,G__4388,(1)));
var G__4388__$2 = (((G__4388__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4388__$1));
var G__4388__$3 = (((G__4388__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4388__$2));
var G__4388__$4 = (((G__4388__$3 == null))?null:cljs.core.symbol.call(null,G__4388__$3));
if((G__4388__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__4388__$4);
}
})():(function (){var G__4389 = token;
var G__4389__$1 = (((G__4389 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4389));
if((G__4389__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4389__$1);
}
})()
));
if(cljs.core.truth_(temp__5802__auto__)){
...
var vec__4390 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4390,(0),null);
var end_column = cljs.core.nth.call(null,vec__4390,(1),null);
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__4403,reader){
var map__4404 = p__4403;
var map__4404__$1 = cljs.core.__destructure_map.call(null,map__4404);
var opts = map__4404__$1;
var eof = cljs.core.get.call(null,map__4404__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
