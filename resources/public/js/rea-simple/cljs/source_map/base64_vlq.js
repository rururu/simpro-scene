...
var digit_5742 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_5743__$1 = (vlq >>> (5));
while(true){
if((vlq_5743__$1 > (0))){
var digit_5744__$1 = (digit_5742 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_5744__$1));

var G__5745 = (vlq_5743__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__5746 = (vlq_5743__$1 >>> (5));
digit_5742 = G__5745;
vlq_5743__$1 = G__5746;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_5742));
}
break;
}
...
var G__5747 = i__$1;
var G__5748 = result__$1;
var G__5749 = shift__$1;
i = G__5747;
result = G__5748;
shift = G__5749;
continue;
