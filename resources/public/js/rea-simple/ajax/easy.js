...
var G__8627 = format;
var G__8627__$1 = (((G__8627 instanceof cljs.core.Keyword))?G__8627.fqn:null);
switch (G__8627__$1) {
case "transit":
return ajax.transit.transit_request_format.call(null,format_params);
...
var G__8629 = format;
var G__8629__$1 = (((G__8629 instanceof cljs.core.Keyword))?G__8629.fqn:null);
switch (G__8629__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__8631_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__8631_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__8632){
var map__8633 = p__8632;
var map__8633__$1 = cljs.core.__destructure_map.call(null,map__8633);
var handler = cljs.core.get.call(null,map__8633__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__8633__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__8633__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__8634){
var vec__8635 = p__8634;
var ok = cljs.core.nth.call(null,vec__8635,(0),null);
var result = cljs.core.nth.call(null,vec__8635,(1),null);
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__8638){
var map__8639 = p__8638;
var map__8639__$1 = cljs.core.__destructure_map.call(null,map__8639);
var opts = map__8639__$1;
var method = cljs.core.get.call(null,map__8639__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__8639__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__8639__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__8639__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.call(null,map__8639__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
