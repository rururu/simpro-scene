...
var longitude = cljs.core.get.call(null,map__25613__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var latitude = cljs.core.get.call(null,map__25613__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var height = cljs.core.get.call(null,map__25613__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var heading = cljs.core.get.call(null,map__25613__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var pitch = cljs.core.get.call(null,map__25613__$1,new cljs.core.Keyword(null,"pitch","pitch",1495126700));
var roll = cljs.core.get.call(null,map__25613__$1,new cljs.core.Keyword(null,"roll","roll",11266999));
...
var map__25616 = settings;
var map__25616__$1 = cljs.core.__destructure_map.call(null,map__25616);
var animate = cljs.core.get.call(null,map__25616__$1,new cljs.core.Keyword(null,"animate","animate",1850194573));
var start = cljs.core.get.call(null,map__25616__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var stop = cljs.core.get.call(null,map__25616__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
var current = cljs.core.get.call(null,map__25616__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var mult = cljs.core.get.call(null,map__25616__$1,new cljs.core.Keyword(null,"mult","mult",1466794774));
var step = cljs.core.get.call(null,map__25616__$1,new cljs.core.Keyword(null,"step","step",1288888124));
var range = cljs.core.get.call(null,map__25616__$1,new cljs.core.Keyword(null,"range","range",1639692286));
...
(clock.clockStep = (function (){var pred__25617 = cljs.core._EQ_;
var expr__25618 = step;
if(cljs.core.truth_(pred__25617.call(null,"TICK_DEPENDENT",expr__25618))){
return Cesium.ClockStep.TICK_DEPENDENT;
} else {
if(cljs.core.truth_(pred__25617.call(null,"SYSTEM_CLOCK_MULTIPLIER",expr__25618))){
return Cesium.ClockStep.SYSTEM_CLOCK_MULTIPLIER;
} else {
if(cljs.core.truth_(pred__25617.call(null,"SYSTEM_CLOCK",expr__25618))){
return Cesium.ClockStep.SYSTEM_CLOCK;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__25618)].join('')));
}
}
}
})());

(clock.clockRange = (function (){var pred__25620 = cljs.core._EQ_;
var expr__25621 = range;
if(cljs.core.truth_(pred__25620.call(null,"UNBOUNDED",expr__25621))){
return Cesium.ClockRange.UNBOUNDED;
} else {
if(cljs.core.truth_(pred__25620.call(null,"CLAMPED",expr__25621))){
return Cesium.ClockRange.CLAMPED;
} else {
if(cljs.core.truth_(pred__25620.call(null,"LOOP_STOP",expr__25621))){
return Cesium.ClockRange.LOOP_STOP;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__25621)].join('')));
}
}
}
})());
...
var promise = (function (){var pred__25624 = cljs.core._EQ_;
var expr__25625 = format;
if(cljs.core.truth_(pred__25624.call(null,new cljs.core.Keyword(null,"GeoJSON","GeoJSON",33508860),expr__25625))){
return Cesium.GeoJsonDataSource.load(source,options);
} else {
if(cljs.core.truth_(pred__25624.call(null,new cljs.core.Keyword(null,"CZML","CZML",-1539311408),expr__25625))){
return Cesium.CzmlDataSource.load(source,options);
} else {
if(cljs.core.truth_(pred__25624.call(null,new cljs.core.Keyword(null,"KML","KML",1829561453),expr__25625))){
...
cesium.client.azimuths_AMPERSAND_points = (function cesium$client$azimuths_AMPERSAND_points(p__25628,radr,hgt,N){
var vec__25629 = p__25628;
var c_lambda = cljs.core.nth.call(null,vec__25629,(0),null);
var c_phi = cljs.core.nth.call(null,vec__25629,(1),null);
var s = ((Math.PI * (2)) / N);
var azs = cljs.core.range.call(null,(0),(N * s),s);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [azs,cljs.core.vec.call(null,cljs.core.map.call(null,(function (p1__25627_SHARP_){
return cljs.core.concat.call(null,cesium.client.position_js.call(null,c_lambda,c_phi,radr,p1__25627_SHARP_),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [hgt], null));
}),azs))], null);
});
...
var vec__25632 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cmp__$1.longitude,cmp__$1.latitude,cmp__$1.height], null);
var lam = cljs.core.nth.call(null,vec__25632,(0),null);
var phi = cljs.core.nth.call(null,vec__25632,(1),null);
var hgt = cljs.core.nth.call(null,vec__25632,(2),null);
var az = camera.heading;
var c = ((((dist_m / (1852)) / (60)) / (180)) * Math.PI);
var vec__25635 = cesium.client.position_js.call(null,lam,phi,c,az);
var lam2 = cljs.core.nth.call(null,vec__25635,(0),null);
var phi2 = cljs.core.nth.call(null,vec__25635,(1),null);
...
var n = ((N / (2)) + cljs.core.count.call(null,cljs.core.filter.call(null,(function (p1__25638_SHARP_){
return (p1__25638_SHARP_ < az);
}),azs)));
if((n > (N - (1)))){
return (n - N);
} else {
...
var pred__25641 = cljs.core._EQ_;
var expr__25642 = cljs.core.deref.call(null,cesium.client.ORBIT).call(null,new cljs.core.Keyword(null,"status","status",-1997798413));
if(cljs.core.truth_(pred__25641.call(null,new cljs.core.Keyword(null,"init","init",-1875481434),expr__25642))){
...
if(cljs.core.truth_(pred__25641.call(null,new cljs.core.Keyword(null,"stop","stop",-2140911342),expr__25642))){
...
var vec__25644 = cesium.client.look_at.call(null,camera,radm);
var lam = cljs.core.nth.call(null,vec__25644,(0),null);
var phi = cljs.core.nth.call(null,vec__25644,(1),null);
var hgt = cljs.core.nth.call(null,vec__25644,(2),null);
var look = vec__25644;
var vec__25647 = cesium.client.azimuths_AMPERSAND_points.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lam,phi], null),radr,hgt,steps);
var azs = cljs.core.nth.call(null,vec__25647,(0),null);
var pts = cljs.core.nth.call(null,vec__25647,(1),null);
var ring = cljs.core.vec.call(null,cljs.core.map.call(null,(function (p1__25639_SHARP_){
return Cesium.Cartesian3.fromRadians(cljs.core.first.call(null,p1__25639_SHARP_),cljs.core.second.call(null,p1__25639_SHARP_),cljs.core.nth.call(null,p1__25639_SHARP_,(2)));
}),pts));
var headings = cljs.core.vec.call(null,cljs.core.map.call(null,(function (p1__25640_SHARP_){
return cesium.client.normaz.call(null,(p1__25640_SHARP_ + Math.PI));
}),azs));
...
if(cljs.core.truth_(pred__25641.call(null,new cljs.core.Keyword(null,"run","run",-1821166653),expr__25642))){
camera.cancelFlight();

return cljs.core._vreset_BANG_.call(null,cesium.client.ORBIT,cljs.core.assoc.call(null,cljs.core._deref.call(null,cesium.client.ORBIT),new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"stop","stop",-2140911342)));
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__25642)].join('')));
}
}
}
}));
