...
var digit_27340 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_27341__$1 = (vlq >>> (5));
while(true){
if((vlq_27341__$1 > (0))){
var digit_27342__$1 = (digit_27340 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_27342__$1));

var G__27343 = (vlq_27341__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__27344 = (vlq_27341__$1 >>> (5));
digit_27340 = G__27343;
vlq_27341__$1 = G__27344;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_27340));
}
break;
}
...
var G__27345 = i__$1;
var G__27346 = result__$1;
var G__27347 = shift__$1;
i = G__27345;
result = G__27346;
shift = G__27347;
continue;
