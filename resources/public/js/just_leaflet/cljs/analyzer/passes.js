...
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__32274_SHARP_){
return cljs.analyzer.passes.walk.call(null,p1__32274_SHARP_,passes,opts);
})),child);
} else {
return cljs.analyzer.passes.walk.call(null,child,passes,opts);
}
})());
}),(function (){var G__32277 = ast;
if((G__32277 == null)){
return null;
} else {
return cljs.analyzer.passes.apply_passes.call(null,G__32277,passes,opts);
}
