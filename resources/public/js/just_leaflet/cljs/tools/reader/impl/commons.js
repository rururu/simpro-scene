...
var vec__32014 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__32014,(0),null);
return (match === s);
});
...
var G__32021 = (i__5770__auto___32020 + (1));
i__5770__auto___32020 = G__32021;
continue;
} else {
}
break;
...
return (function() { 
var G__32022__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__32022 = function (rdr,var_args){
var _ = null;
...
while (G__32023__i < G__32023__a.length) {G__32023__a[G__32023__i] = arguments[G__32023__i + 1]; ++G__32023__i;}
  _ = new cljs.core.IndexedSeq(G__32023__a,0,null);
} 
return G__32022__delegate.call(this,rdr,_);};
G__32022.cljs$lang$maxFixedArity = 1;
G__32022.cljs$lang$applyTo = (function (arglist__32024){
var rdr = cljs.core.first(arglist__32024);
var _ = cljs.core.rest(arglist__32024);
return G__32022__delegate(rdr,_);
});
