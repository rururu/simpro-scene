...
var map__31827 = view;
var map__31827__$1 = cljs.core.__destructure_map.call(null,map__31827);
var longitude = cljs.core.get.call(null,map__31827__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var latitude = cljs.core.get.call(null,map__31827__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var height = cljs.core.get.call(null,map__31827__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var heading = cljs.core.get.call(null,map__31827__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var pitch = cljs.core.get.call(null,map__31827__$1,new cljs.core.Keyword(null,"pitch","pitch",1495126700));
var roll = cljs.core.get.call(null,map__31827__$1,new cljs.core.Keyword(null,"roll","roll",11266999));
...
cesium.client.VIEWER.homeButton.viewModel.command.beforeExecute.addEventListener((function (e){
(e.cancel = true);
...
var map__31830 = settings;
var map__31830__$1 = cljs.core.__destructure_map.call(null,map__31830);
var animate = cljs.core.get.call(null,map__31830__$1,new cljs.core.Keyword(null,"animate","animate",1850194573));
var start = cljs.core.get.call(null,map__31830__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var stop = cljs.core.get.call(null,map__31830__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
var current = cljs.core.get.call(null,map__31830__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var mult = cljs.core.get.call(null,map__31830__$1,new cljs.core.Keyword(null,"mult","mult",1466794774));
var step = cljs.core.get.call(null,map__31830__$1,new cljs.core.Keyword(null,"step","step",1288888124));
var range = cljs.core.get.call(null,map__31830__$1,new cljs.core.Keyword(null,"range","range",1639692286));
...
(clock.clockStep = (function (){var pred__31831 = cljs.core._EQ_;
var expr__31832 = step;
if(cljs.core.truth_(pred__31831.call(null,"TICK_DEPENDENT",expr__31832))){
return Cesium.ClockStep.TICK_DEPENDENT;
} else {
if(cljs.core.truth_(pred__31831.call(null,"SYSTEM_CLOCK_MULTIPLIER",expr__31832))){
return Cesium.ClockStep.SYSTEM_CLOCK_MULTIPLIER;
} else {
if(cljs.core.truth_(pred__31831.call(null,"SYSTEM_CLOCK",expr__31832))){
return Cesium.ClockStep.SYSTEM_CLOCK;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__31832)].join('')));
}
}
}
})());

(clock.clockRange = (function (){var pred__31834 = cljs.core._EQ_;
var expr__31835 = range;
if(cljs.core.truth_(pred__31834.call(null,"UNBOUNDED",expr__31835))){
return Cesium.ClockRange.UNBOUNDED;
} else {
if(cljs.core.truth_(pred__31834.call(null,"CLAMPED",expr__31835))){
return Cesium.ClockRange.CLAMPED;
} else {
if(cljs.core.truth_(pred__31834.call(null,"LOOP_STOP",expr__31835))){
return Cesium.ClockRange.LOOP_STOP;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__31835)].join('')));
}
}
}
})());
...
var promise = (function (){var pred__31838 = cljs.core._EQ_;
var expr__31839 = format;
if(cljs.core.truth_(pred__31838.call(null,new cljs.core.Keyword(null,"GeoJSON","GeoJSON",33508860),expr__31839))){
return Cesium.GeoJsonDataSource.load(source,options);
} else {
if(cljs.core.truth_(pred__31838.call(null,new cljs.core.Keyword(null,"CZML","CZML",-1539311408),expr__31839))){
return Cesium.CzmlDataSource.load(source,options);
} else {
if(cljs.core.truth_(pred__31838.call(null,new cljs.core.Keyword(null,"KML","KML",1829561453),expr__31839))){
return Cesium.KmlDataSource.load(source,options);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__31839)].join('')));
}
}
}
})();
...
cesium.client.azimuths_AMPERSAND_points = (function cesium$client$azimuths_AMPERSAND_points(p__31842,radr,hgt,N){
var vec__31843 = p__31842;
var c_lambda = cljs.core.nth.call(null,vec__31843,(0),null);
var c_phi = cljs.core.nth.call(null,vec__31843,(1),null);
var s = ((Math.PI * (2)) / N);
var azs = cljs.core.range.call(null,(0),(N * s),s);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [azs,cljs.core.vec.call(null,cljs.core.map.call(null,(function (p1__31841_SHARP_){
return cljs.core.concat.call(null,cesium.client.position_js.call(null,c_lambda,c_phi,radr,p1__31841_SHARP_),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [hgt], null));
}),azs))], null);
});
...
var vec__31846 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cmp__$1.longitude,cmp__$1.latitude,cmp__$1.height], null);
var lam = cljs.core.nth.call(null,vec__31846,(0),null);
var phi = cljs.core.nth.call(null,vec__31846,(1),null);
var hgt = cljs.core.nth.call(null,vec__31846,(2),null);
var az = camera.heading;
var c = ((((dist_m / (1852)) / (60)) / (180)) * Math.PI);
var vec__31849 = cesium.client.position_js.call(null,lam,phi,c,az);
var lam2 = cljs.core.nth.call(null,vec__31849,(0),null);
var phi2 = cljs.core.nth.call(null,vec__31849,(1),null);
...
var n = ((N / (2)) + cljs.core.count.call(null,cljs.core.filter.call(null,(function (p1__31852_SHARP_){
return (p1__31852_SHARP_ < az);
}),azs)));
if((n > (N - (1)))){
return (n - N);
} else {
...
return (obut.onclick = (function (){
var pred__31855 = cljs.core._EQ_;
var expr__31856 = cljs.core.deref.call(null,cesium.client.ORBIT).call(null,new cljs.core.Keyword(null,"status","status",-1997798413));
if(cljs.core.truth_(pred__31855.call(null,new cljs.core.Keyword(null,"init","init",-1875481434),expr__31856))){
...
if(cljs.core.truth_(pred__31855.call(null,new cljs.core.Keyword(null,"stop","stop",-2140911342),expr__31856))){
...
var vec__31858 = cesium.client.look_at.call(null,camera,radm);
var lam = cljs.core.nth.call(null,vec__31858,(0),null);
var phi = cljs.core.nth.call(null,vec__31858,(1),null);
var hgt = cljs.core.nth.call(null,vec__31858,(2),null);
var look = vec__31858;
var vec__31861 = cesium.client.azimuths_AMPERSAND_points.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lam,phi], null),radr,hgt,steps);
var azs = cljs.core.nth.call(null,vec__31861,(0),null);
var pts = cljs.core.nth.call(null,vec__31861,(1),null);
var ring = cljs.core.vec.call(null,cljs.core.map.call(null,(function (p1__31853_SHARP_){
return Cesium.Cartesian3.fromRadians(cljs.core.first.call(null,p1__31853_SHARP_),cljs.core.second.call(null,p1__31853_SHARP_),cljs.core.nth.call(null,p1__31853_SHARP_,(2)));
}),pts));
var headings = cljs.core.vec.call(null,cljs.core.map.call(null,(function (p1__31854_SHARP_){
return cesium.client.normaz.call(null,(p1__31854_SHARP_ + Math.PI));
}),azs));
...
if(cljs.core.truth_(pred__31855.call(null,new cljs.core.Keyword(null,"run","run",-1821166653),expr__31856))){
camera.cancelFlight();

return cljs.core._vreset_BANG_.call(null,cesium.client.ORBIT,cljs.core.assoc.call(null,cljs.core._deref.call(null,cesium.client.ORBIT),new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"stop","stop",-2140911342)));
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__31856)].join('')));
}
}
}
}));
...
var temp__5802__auto__ = cesium.client.VIEWER.camera.pickEllipsoid(mov.endPosition,cesium.client.SCENE.globe.ellipsoid);
if(cljs.core.truth_(temp__5802__auto__)){
var crt = temp__5802__auto__;
