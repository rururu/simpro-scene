...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_35906 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_35906.call(null,this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_35907 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_35907.call(null,this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_35908 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_35908.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_35909 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_35909.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_35910 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_35910.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_35911 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_35911.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_35912 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_35912.call(null,this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_35913 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_35913.call(null,this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_35914 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_35914.call(null,this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_35915 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_35915.call(null,this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k35917,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k35917,else__5346__auto__);
...
return cljs.core.reduce.call(null,(function (ret__5366__auto__,p__35922){
var vec__35923 = p__35922;
var k__5367__auto__ = cljs.core.nth.call(null,vec__35923,(0),null);
var v__5368__auto__ = cljs.core.nth.call(null,vec__35923,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__35916){
var self__ = this;
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this35918,other35919){
var self__ = this;
var this35918__$1 = this;
return (((!((other35919 == null)))) && ((((this35918__$1.constructor === other35919.constructor)) && (((cljs.core._EQ_.call(null,this35918__$1.status,other35919.status)) && (((cljs.core._EQ_.call(null,this35918__$1.body,other35919.body)) && (((cljs.core._EQ_.call(null,this35918__$1.status_text,other35919.status_text)) && (((cljs.core._EQ_.call(null,this35918__$1.headers,other35919.headers)) && (((cljs.core._EQ_.call(null,this35918__$1.was_aborted,other35919.was_aborted)) && (cljs.core._EQ_.call(null,this35918__$1.__extmap,other35919.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k35917){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_.call(null,self__.__extmap,k35917);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__35916){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__35927 = cljs.core.keyword_identical_QMARK_;
var expr__35928 = k__5352__auto__;
if(cljs.core.truth_(pred__35927.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__35928))){
return (new ajax.protocols.Response(G__35916,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__35927.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__35928))){
return (new ajax.protocols.Response(self__.status,G__35916,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__35927.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__35928))){
return (new ajax.protocols.Response(self__.status,self__.body,G__35916,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__35927.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__35928))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__35916,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__35927.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__35928))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__35916,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5352__auto__,G__35916),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__35916){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__35916,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__35920){
var extmap__5385__auto__ = (function (){var G__35930 = cljs.core.dissoc.call(null,G__35920,new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828));
if(cljs.core.record_QMARK_.call(null,G__35920)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__35930);
} else {
return G__35930;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__35920),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__35920),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__35920),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__35920),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__35920),null,cljs.core.not_empty.call(null,extmap__5385__auto__),null));
});
