...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_18629 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_18629.call(null,this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_18630 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_18630.call(null,this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_18631 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_18631.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_18632 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_18632.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_18633 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_18633.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_18634 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_18634.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_18635 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_18635.call(null,this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_18636 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_18636.call(null,this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_18637 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_18637.call(null,this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_18638 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_18638.call(null,this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k18640,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k18640,else__5346__auto__);
...
return cljs.core.reduce.call(null,(function (ret__5366__auto__,p__18645){
var vec__18646 = p__18645;
var k__5367__auto__ = cljs.core.nth.call(null,vec__18646,(0),null);
var v__5368__auto__ = cljs.core.nth.call(null,vec__18646,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__18639){
var self__ = this;
var G__18639__$1 = this;
return (new cljs.core.RecordIter((0),G__18639__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this18641,other18642){
var self__ = this;
var this18641__$1 = this;
return (((!((other18642 == null)))) && ((((this18641__$1.constructor === other18642.constructor)) && (((cljs.core._EQ_.call(null,this18641__$1.status,other18642.status)) && (((cljs.core._EQ_.call(null,this18641__$1.body,other18642.body)) && (((cljs.core._EQ_.call(null,this18641__$1.status_text,other18642.status_text)) && (((cljs.core._EQ_.call(null,this18641__$1.headers,other18642.headers)) && (((cljs.core._EQ_.call(null,this18641__$1.was_aborted,other18642.was_aborted)) && (cljs.core._EQ_.call(null,this18641__$1.__extmap,other18642.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k18640){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_.call(null,self__.__extmap,k18640);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__18639){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__18650 = cljs.core.keyword_identical_QMARK_;
var expr__18651 = k__5352__auto__;
if(cljs.core.truth_(pred__18650.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__18651))){
return (new ajax.protocols.Response(G__18639,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__18650.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__18651))){
return (new ajax.protocols.Response(self__.status,G__18639,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__18650.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__18651))){
return (new ajax.protocols.Response(self__.status,self__.body,G__18639,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__18650.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__18651))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__18639,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__18650.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__18651))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__18639,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5352__auto__,G__18639),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__18639){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__18639,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__18643){
var extmap__5385__auto__ = (function (){var G__18653 = cljs.core.dissoc.call(null,G__18643,new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828));
if(cljs.core.record_QMARK_.call(null,G__18643)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__18653);
} else {
return G__18653;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__18643),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__18643),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__18643),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__18643),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__18643),null,cljs.core.not_empty.call(null,extmap__5385__auto__),null));
});
