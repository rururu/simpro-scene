...
var digit_5021 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_5022__$1 = (vlq >>> (5));
while(true){
if((vlq_5022__$1 > (0))){
var digit_5023__$1 = (digit_5021 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_5023__$1));

var G__5024 = (vlq_5022__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__5025 = (vlq_5022__$1 >>> (5));
digit_5021 = G__5024;
vlq_5022__$1 = G__5025;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_5021));
}
break;
}
...
var G__5026 = i__$1;
var G__5027 = result__$1;
var G__5028 = shift__$1;
i = G__5026;
result = G__5027;
shift = G__5028;
continue;
