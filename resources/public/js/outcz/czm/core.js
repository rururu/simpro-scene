...
czm.core.sample_height = (function czm$core$sample_height(p__22015,alt){
var vec__22016 = p__22015;
var phi = cljs.core.nth.call(null,vec__22016,(0),null);
var lam = cljs.core.nth.call(null,vec__22016,(1),null);
...
var vec__22019 = czm.core.sample_height.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [geo.calc.radians.call(null,lat),geo.calc.radians.call(null,lon)], null),czm.core.ALT);
var _ = cljs.core.nth.call(null,vec__22019,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__22019,(1),null);
var sh = cljs.core.nth.call(null,vec__22019,(2),null);
if((sh > (-7777))){
...
return czm.core.sample_height.call(null,p1__22022_SHARP_,alt);
});})(ray))
,ray);
});
...
if((h2 <= alt)){
var G__22023 = fr;
var G__22024 = cljs.core.rest.call(null,r);
f = G__22023;
r = G__22024;
continue;
} else {
...
var vec__22025 = center;
var lat = cljs.core.nth.call(null,vec__22025,(0),null);
var lon = cljs.core.nth.call(null,vec__22025,(1),null);
var vec__22028 = sector;
var start = cljs.core.nth.call(null,vec__22028,(0),null);
var end = cljs.core.nth.call(null,vec__22028,(1),null);
var losec = (function (){var iter__4434__auto__ = ((function (vec__22025,lat,lon,vec__22028,start,end){
return (function czm$core$los_sector_$_iter__22031(s__22032){
return (new cljs.core.LazySeq(null,((function (vec__22025,lat,lon,vec__22028,start,end){
return (function (){
var s__22032__$1 = s__22032;
while(true){
var temp__5720__auto__ = cljs.core.seq.call(null,s__22032__$1);
if(temp__5720__auto__){
var s__22032__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__22032__$2)){
var c__4432__auto__ = cljs.core.chunk_first.call(null,s__22032__$2);
var size__4433__auto__ = cljs.core.count.call(null,c__4432__auto__);
var b__22034 = cljs.core.chunk_buffer.call(null,size__4433__auto__);
if((function (){var i__22033 = (0);
while(true){
if((i__22033 < size__4433__auto__)){
var bea = cljs.core._nth.call(null,c__4432__auto__,i__22033);
cljs.core.chunk_append.call(null,b__22034,czm.core.los_end.call(null,lat,lon,bea,dist,dist_step,alt));

var G__22035 = (i__22033 + (1));
i__22033 = G__22035;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__22034),czm$core$los_sector_$_iter__22031.call(null,cljs.core.chunk_rest.call(null,s__22032__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__22034),null);
}
} else {
var bea = cljs.core.first.call(null,s__22032__$2);
return cljs.core.cons.call(null,czm.core.los_end.call(null,lat,lon,bea,dist,dist_step,alt),czm$core$los_sector_$_iter__22031.call(null,cljs.core.rest.call(null,s__22032__$2)));
}
} else {
return null;
}
...
});})(vec__22025,lat,lon,vec__22028,start,end))
,null,null));
});})(vec__22025,lat,lon,vec__22028,start,end))
;
