...
czm.core.sample_height = (function czm$core$sample_height(p__10802,alt){
var vec__10803 = p__10802;
var phi = cljs.core.nth.call(null,vec__10803,(0),null);
var lam = cljs.core.nth.call(null,vec__10803,(1),null);
...
var vec__10806 = czm.core.sample_height.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [geo.calc.radians.call(null,lat),geo.calc.radians.call(null,lon)], null),czm.core.ALT);
var _ = cljs.core.nth.call(null,vec__10806,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__10806,(1),null);
var sh = cljs.core.nth.call(null,vec__10806,(2),null);
if((sh > (-7777))){
...
return czm.core.sample_height.call(null,p1__10809_SHARP_,alt);
});})(ray))
,ray);
});
...
if((h2 <= alt)){
var G__10810 = fr;
var G__10811 = cljs.core.rest.call(null,r);
f = G__10810;
r = G__10811;
continue;
} else {
...
var vec__10812 = center;
var lat = cljs.core.nth.call(null,vec__10812,(0),null);
var lon = cljs.core.nth.call(null,vec__10812,(1),null);
var vec__10815 = sector;
var start = cljs.core.nth.call(null,vec__10815,(0),null);
var end = cljs.core.nth.call(null,vec__10815,(1),null);
var losec = (function (){var iter__4434__auto__ = ((function (vec__10812,lat,lon,vec__10815,start,end){
return (function czm$core$los_sector_$_iter__10818(s__10819){
return (new cljs.core.LazySeq(null,((function (vec__10812,lat,lon,vec__10815,start,end){
return (function (){
var s__10819__$1 = s__10819;
while(true){
var temp__5735__auto__ = cljs.core.seq.call(null,s__10819__$1);
if(temp__5735__auto__){
var s__10819__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__10819__$2)){
var c__4432__auto__ = cljs.core.chunk_first.call(null,s__10819__$2);
var size__4433__auto__ = cljs.core.count.call(null,c__4432__auto__);
var b__10821 = cljs.core.chunk_buffer.call(null,size__4433__auto__);
if((function (){var i__10820 = (0);
while(true){
if((i__10820 < size__4433__auto__)){
var bea = cljs.core._nth.call(null,c__4432__auto__,i__10820);
cljs.core.chunk_append.call(null,b__10821,czm.core.los_end.call(null,lat,lon,bea,dist,dist_step,alt));

var G__10822 = (i__10820 + (1));
i__10820 = G__10822;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__10821),czm$core$los_sector_$_iter__10818.call(null,cljs.core.chunk_rest.call(null,s__10819__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__10821),null);
}
} else {
var bea = cljs.core.first.call(null,s__10819__$2);
return cljs.core.cons.call(null,czm.core.los_end.call(null,lat,lon,bea,dist,dist_step,alt),czm$core$los_sector_$_iter__10818.call(null,cljs.core.rest.call(null,s__10819__$2)));
}
} else {
return null;
}
...
});})(vec__10812,lat,lon,vec__10815,start,end))
,null,null));
});})(vec__10812,lat,lon,vec__10815,start,end))
;
