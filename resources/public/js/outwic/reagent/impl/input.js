...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__27629){
...
var on_write = cljs.core.get.call(null,map__27630__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__27630,map__27630__$1,on_write){
return (function (){
return reagent.impl.input.input_component_set_value.call(null,component);
});})(node_value,map__27630,map__27630__$1,on_write))
);
} else {
...
:(cljs.core.truth_((function (){var and__4036__auto__ = original_ref_fn;
...
return reagent.impl.input.input_handle_change.call(null,this$,on_change,p1__27632_SHARP_);
});})(v,value,on_change,original_ref_fn))
;
