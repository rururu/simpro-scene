...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__24048){
...
var handler = cljs.core.get.call(null,map__24049__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__4047__auto__ = p1__24051_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__24052){
...
var request = map__24053__$1;
var interceptors = cljs.core.get.call(null,map__24053__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
