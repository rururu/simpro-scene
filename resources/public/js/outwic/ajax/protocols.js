...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4303__auto__,k5263,else__4304__auto__){
var self__ = this;
var this__4303__auto____$1 = this;
var G__5267 = k5263;
var G__5267__$1 = (((G__5267 instanceof cljs.core.Keyword))?G__5267.fqn:null);
switch (G__5267__$1) {
case "status":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k5263,else__4304__auto__);
...
return (function (ret__4323__auto__,p__5268){
var vec__5269 = p__5268;
var k__4324__auto__ = cljs.core.nth.call(null,vec__5269,(0),null);
var v__4325__auto__ = cljs.core.nth.call(null,vec__5269,(1),null);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__5262){
var self__ = this;
var G__5262__$1 = this;
return (new cljs.core.RecordIter((0),G__5262__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this5264,other5265){
var self__ = this;
var this5264__$1 = this;
return (((!((other5265 == null)))) && ((this5264__$1.constructor === other5265.constructor)) && (cljs.core._EQ_.call(null,this5264__$1.status,other5265.status)) && (cljs.core._EQ_.call(null,this5264__$1.body,other5265.body)) && (cljs.core._EQ_.call(null,this5264__$1.status_text,other5265.status_text)) && (cljs.core._EQ_.call(null,this5264__$1.headers,other5265.headers)) && (cljs.core._EQ_.call(null,this5264__$1.was_aborted,other5265.was_aborted)) && (cljs.core._EQ_.call(null,this5264__$1.__extmap,other5265.__extmap)));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4308__auto__,k__4309__auto__,G__5262){
var self__ = this;
var this__4308__auto____$1 = this;
var pred__5272 = cljs.core.keyword_identical_QMARK_;
var expr__5273 = k__4309__auto__;
if(cljs.core.truth_(pred__5272.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__5273))){
return (new ajax.protocols.Response(G__5262,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__5272.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__5273))){
return (new ajax.protocols.Response(self__.status,G__5262,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__5272.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__5273))){
return (new ajax.protocols.Response(self__.status,self__.body,G__5262,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__5272.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__5273))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__5262,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__5272.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__5273))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__5262,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4309__auto__,G__5262),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4300__auto__,G__5262){
var self__ = this;
var this__4300__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__5262,self__.__extmap,self__.__hash));
});
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__5266){
var extmap__4340__auto__ = (function (){var G__5275 = cljs.core.dissoc.call(null,G__5266,new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828));
if(cljs.core.record_QMARK_.call(null,G__5266)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__5275);
} else {
return G__5275;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__5266),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__5266),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__5266),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__5266),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__5266),null,cljs.core.not_empty.call(null,extmap__4340__auto__),null));
});
