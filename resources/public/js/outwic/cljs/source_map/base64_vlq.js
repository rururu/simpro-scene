...
var digit_19491 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_19492__$1 = (vlq >>> (5));
while(true){
if((vlq_19492__$1 > (0))){
var digit_19493__$1 = (digit_19491 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_19493__$1));

var G__19494 = (vlq_19492__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__19495 = (vlq_19492__$1 >>> (5));
digit_19491 = G__19494;
vlq_19492__$1 = G__19495;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_19491));
}
break;
}
...
var G__19496 = i__$1;
var G__19497 = result__$1;
var G__19498 = shift__$1;
i = G__19496;
result = G__19497;
shift = G__19498;
continue;
