...
var pitch = (function (){var pred__10004 = cljs.core._EQ_;
var expr__10005 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__10004.call(null,"UP",expr__10005))){
return (90);
} else {
if(cljs.core.truth_(pred__10004.call(null,"DOWN",expr__10005))){
return (-90);
} else {
...
var head = czm.core.norm_crs.call(null,(function (){var pred__10007 = cljs.core._EQ_;
var expr__10008 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__10007.call(null,"BACKWARD",expr__10008))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__10007.call(null,"RIGHT",expr__10008))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__10007.call(null,"LEFT",expr__10008))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__10007.call(null,"FORWARD-RIGHT",expr__10008))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__10007.call(null,"FORWARD-LEFT",expr__10008))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__10007.call(null,"BACKWARD-RIGHT",expr__10008))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__10007.call(null,"BACKWARD-LEFT",expr__10008))){
return (crs - (135));
} else {
return crs;
}
...
var pitch = (function (){var pred__10016 = cljs.core._EQ_;
var expr__10017 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__10016.call(null,"UP",expr__10017))){
return (90);
} else {
if(cljs.core.truth_(pred__10016.call(null,"DOWN",expr__10017))){
return (-90);
} else {
return new cljs.core.Keyword(null,"pitch","pitch",1495126700).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
}
...
var roll = new cljs.core.Keyword(null,"roll","roll",11266999).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
var head = czm.core.norm_crs.call(null,(function (){var pred__10019 = cljs.core._EQ_;
var expr__10020 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__10019.call(null,"BACKWARD",expr__10020))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__10019.call(null,"RIGHT",expr__10020))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__10019.call(null,"LEFT",expr__10020))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__10019.call(null,"FORWARD-RIGHT",expr__10020))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__10019.call(null,"FORWARD-LEFT",expr__10020))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__10019.call(null,"BACKWARD-RIGHT",expr__10020))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__10019.call(null,"BACKWARD-LEFT",expr__10020))){
return (crs - (135));
} else {
return crs;
}
