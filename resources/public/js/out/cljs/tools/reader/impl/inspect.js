...
var l = (cljs.core.truth_(truncate)?(0):(function (){var x__10021__auto__ = (10);
var y__10022__auto__ = n;
return ((x__10021__auto__ < y__10022__auto__) ? x__10021__auto__ : y__10022__auto__);
})());
...
cljs.tools.reader.impl.inspect.inspect_STAR_ = (function (){var method_table__10717__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
var prefer_table__10718__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
var method_cache__10719__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__10720__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__10721__auto__ = cljs.core.get.call(null,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),cljs.core.get_global_hierarchy.call(null));
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.tools.reader.impl.inspect","inspect*"),cljs.tools.reader.impl.inspect.dispatch_inspect,new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__10721__auto__,method_table__10717__auto__,prefer_table__10718__auto__,method_cache__10719__auto__,cached_hierarchy__10720__auto__));
})();
}
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1("\""),cljs.core.str.cljs$core$IFn$_invoke$arity$1(x.substring((0),(function (){var x__10021__auto__ = n;
var y__10022__auto__ = x.length;
return ((x__10021__auto__ < y__10022__auto__) ? x__10021__auto__ : y__10022__auto__);
