...
var G__2294 = format;
var G__2294__$1 = (((G__2294 instanceof cljs.core.Keyword))?G__2294.fqn:null);
switch (G__2294__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__2296_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__2296_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__2297){
var map__2298 = p__2297;
var map__2298__$1 = cljs.core.__destructure_map.call(null,map__2298);
var handler = cljs.core.get.call(null,map__2298__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__2298__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__2298__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__2299){
var vec__2300 = p__2299;
var ok = cljs.core.nth.call(null,vec__2300,(0),null);
var result = cljs.core.nth.call(null,vec__2300,(1),null);
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__2303){
var map__2304 = p__2303;
var map__2304__$1 = cljs.core.__destructure_map.call(null,map__2304);
var opts = map__2304__$1;
var method = cljs.core.get.call(null,map__2304__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__2304__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__2304__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__2304__$1,new cljs.core.Keyword(null,"params","params",710516235));
