...
var G__2529 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__2529,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__2530__delegate = function (args){
...
while (G__2531__i < G__2531__a.length) {G__2531__a[G__2531__i] = arguments[G__2531__i + 0]; ++G__2531__i;}
  args = new cljs.core.IndexedSeq(G__2531__a,0,null);
} 
return G__2530__delegate.call(this,args);};
G__2530.cljs$lang$maxFixedArity = 0;
G__2530.cljs$lang$applyTo = (function (arglist__2532){
var args = cljs.core.seq(arglist__2532);
return G__2530__delegate(args);
});
...
var G__2533 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__2533,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__2534__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
var G__2537 = props;
var G__2537__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__2537,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__2537);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__2537__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__2538 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__2538,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__2538;
}
})(),id_class);
...
var G__2539 = (cljs.core.count.call(null,argv) - first_child);
switch (G__2539) {
case (0):
...
var vec__2541 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__2541,(0),null);
var id = cljs.core.nth.call(null,vec__2541,(1),null);
var className = cljs.core.nth.call(null,vec__2541,(2),null);
...
var temp__5808__auto___2544 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___2544 == null)){
} else {
var key_2545 = temp__5808__auto___2544;
(jsprops.key = key_2545);
}
...
var temp__5808__auto___2546 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___2546 == null)){
} else {
var key_2547 = temp__5808__auto___2546;
(jsprops.key = key_2547);
}
...
var temp__5808__auto___2548 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5808__auto___2548 == null)){
} else {
var key_2549 = temp__5808__auto___2548;
(jsprops.key = key_2549);
}
...
var temp__5808__auto___2550 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___2550 == null)){
} else {
var key_2551 = temp__5808__auto___2550;
(jsprops.key = key_2551);
}
...
var temp__5808__auto___2552 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___2552 == null)){
} else {
var key_2553 = temp__5808__auto___2552;
(jsprops.key = key_2553);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__2554_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__2554_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__2555 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__2555,(0),null);
var derefed = cljs.core.nth.call(null,vec__2555,(1),null);
...
break;
default:
var G__2560 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__2561 = compiler;
v = G__2560;
compiler = G__2561;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template2565 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template2565 = (function (opts,id,fn_to_element,parse_fn,meta2566){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta2566 = meta2566;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template2565.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_2567,meta2566__$1){
var self__ = this;
var _2567__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template2565(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta2566__$1));
}));

(reagent.impl.template.t_reagent$impl$template2565.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_2567){
var self__ = this;
var _2567__$1 = this;
return self__.meta2566;
}));

(reagent.impl.template.t_reagent$impl$template2565.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template2565.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template2565.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template2565.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template2565.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template2565.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta2566","meta2566",1938041100,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template2565.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template2565.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template2565");

(reagent.impl.template.t_reagent$impl$template2565.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write.call(null,writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template2565");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template2565.
 */
reagent.impl.template.__GT_t_reagent$impl$template2565 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template2565(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta2566){
return (new reagent.impl.template.t_reagent$impl$template2565(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta2566));
});

}

return (new reagent.impl.template.t_reagent$impl$template2565(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
