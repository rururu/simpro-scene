...
var len__5769__auto___2881 = arguments.length;
var i__5770__auto___2882 = (0);
while(true){
if((i__5770__auto___2882 < len__5769__auto___2881)){
args__5775__auto__.push((arguments[i__5770__auto___2882]));

var G__2883 = (i__5770__auto___2882 + (1));
i__5770__auto___2882 = G__2883;
continue;
} else {
}
break;
...
var props__$1 = (function (){var G__2880 = props;
var G__2880__$1 = (cljs.core.truth_(input_component)?cljs.core.update.call(null,G__2880,new cljs.core.Keyword(null,"InputProps","InputProps",-1485068760),(function (p1__2877_SHARP_){
return reagent_mui.util.assoc_anycase.call(null,p1__2877_SHARP_,new cljs.core.Keyword(null,"input-component","input-component",-745892912),input_component);
})):G__2880);
if(cljs.core.truth_(autosize_QMARK_)){
return cljs.core.update.call(null,G__2880__$1,new cljs.core.Keyword(null,"input-props","input-props",-1504868202),cljs.core.merge,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-rows","max-rows",-2131113613),max_rows,new cljs.core.Keyword(null,"min-rows","min-rows",1428640765),min_rows], null));
} else {
return G__2880__$1;
}
})();
...
/** @this {Function} */
(reagent_mui.material.text_field.text_field.cljs$lang$applyTo = (function (seq2878){
var G__2879 = cljs.core.first.call(null,seq2878);
var seq2878__$1 = cljs.core.next.call(null,seq2878);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__2879,seq2878__$1);
}));
