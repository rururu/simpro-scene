...
czm.core.sample_height = (function czm$core$sample_height(p__33348,alt){
var vec__33349 = p__33348;
var phi = cljs.core.nth.call(null,vec__33349,(0),null);
var lam = cljs.core.nth.call(null,vec__33349,(1),null);
...
var vec__33352 = czm.core.sample_height.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [geo.calc.radians.call(null,lat),geo.calc.radians.call(null,lon)], null),czm.core.ALT);
var _ = cljs.core.nth.call(null,vec__33352,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__33352,(1),null);
var sh = cljs.core.nth.call(null,vec__33352,(2),null);
if((sh > (-7777))){
...
return czm.core.sample_height.call(null,p1__33355_SHARP_,alt);
});})(ray))
,ray);
});
...
if((h2 <= alt)){
var G__33356 = fr;
var G__33357 = cljs.core.rest.call(null,r);
f = G__33356;
r = G__33357;
continue;
} else {
...
var vec__33358 = center;
var lat = cljs.core.nth.call(null,vec__33358,(0),null);
var lon = cljs.core.nth.call(null,vec__33358,(1),null);
var vec__33361 = sector;
var start = cljs.core.nth.call(null,vec__33361,(0),null);
var end = cljs.core.nth.call(null,vec__33361,(1),null);
var losec = (function (){var iter__4434__auto__ = ((function (vec__33358,lat,lon,vec__33361,start,end){
return (function czm$core$los_sector_$_iter__33364(s__33365){
return (new cljs.core.LazySeq(null,((function (vec__33358,lat,lon,vec__33361,start,end){
return (function (){
var s__33365__$1 = s__33365;
while(true){
var temp__5735__auto__ = cljs.core.seq.call(null,s__33365__$1);
if(temp__5735__auto__){
var s__33365__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__33365__$2)){
var c__4432__auto__ = cljs.core.chunk_first.call(null,s__33365__$2);
var size__4433__auto__ = cljs.core.count.call(null,c__4432__auto__);
var b__33367 = cljs.core.chunk_buffer.call(null,size__4433__auto__);
if((function (){var i__33366 = (0);
while(true){
if((i__33366 < size__4433__auto__)){
var bea = cljs.core._nth.call(null,c__4432__auto__,i__33366);
cljs.core.chunk_append.call(null,b__33367,czm.core.los_end.call(null,lat,lon,bea,dist,dist_step,alt));

var G__33368 = (i__33366 + (1));
i__33366 = G__33368;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33367),czm$core$los_sector_$_iter__33364.call(null,cljs.core.chunk_rest.call(null,s__33365__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33367),null);
}
} else {
var bea = cljs.core.first.call(null,s__33365__$2);
return cljs.core.cons.call(null,czm.core.los_end.call(null,lat,lon,bea,dist,dist_step,alt),czm$core$los_sector_$_iter__33364.call(null,cljs.core.rest.call(null,s__33365__$2)));
}
} else {
return null;
}
...
});})(vec__33358,lat,lon,vec__33361,start,end))
,null,null));
});})(vec__33358,lat,lon,vec__33361,start,end))
;
