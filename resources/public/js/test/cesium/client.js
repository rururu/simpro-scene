...
var longitude = cljs.core.get.call(null,map__14648__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var latitude = cljs.core.get.call(null,map__14648__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var height = cljs.core.get.call(null,map__14648__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var heading = cljs.core.get.call(null,map__14648__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var pitch = cljs.core.get.call(null,map__14648__$1,new cljs.core.Keyword(null,"pitch","pitch",1495126700));
var roll = cljs.core.get.call(null,map__14648__$1,new cljs.core.Keyword(null,"roll","roll",11266999));
...
cesium.client.VIEWER.homeButton.viewModel.command.beforeExecute.addEventListener(((function (map__14648,map__14648__$1,longitude,latitude,height,heading,pitch,roll,fvw){
return (function (e){
e.cancel = true;

return camera.flyTo(cesium.client.HOME_VIEW);
});})(map__14648,map__14648__$1,longitude,latitude,height,heading,pitch,roll,fvw))
);
...
break;
case 7:
return cesium.client.clock_settings.cljs$core$IFn$_invoke$arity$7((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),(arguments[(3)]),(arguments[(4)]),(arguments[(5)]),(arguments[(6)]));
...
var animate = cljs.core.get.call(null,map__14652__$1,new cljs.core.Keyword(null,"animate","animate",1850194573));
var start = cljs.core.get.call(null,map__14652__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var stop = cljs.core.get.call(null,map__14652__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
var current = cljs.core.get.call(null,map__14652__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var mult = cljs.core.get.call(null,map__14652__$1,new cljs.core.Keyword(null,"mult","mult",1466794774));
return cesium.client.clock_settings.call(null,clock,animate,start,stop,current,mult,viewer);
});

cesium.client.clock_settings.cljs$core$IFn$_invoke$arity$7 = (function (clock,animate,start,stop,current,mult,viewer){
...
cesium.client.clock_settings.cljs$lang$maxFixedArity = 7;

cesium.client.load_data = (function cesium$client$load_data(format,source,options,viewer,processor){
var promise = (function (){var pred__14655 = cljs.core._EQ_;
var expr__14656 = format;
if(cljs.core.truth_(pred__14655.call(null,new cljs.core.Keyword(null,"GeoJSON","GeoJSON",33508860),expr__14656))){
return Cesium.GeoJsonDataSource.load(source,options);
} else {
if(cljs.core.truth_(pred__14655.call(null,new cljs.core.Keyword(null,"CZML","CZML",-1539311408),expr__14656))){
return Cesium.CzmlDataSource.load(source,options);
} else {
if(cljs.core.truth_(pred__14655.call(null,new cljs.core.Keyword(null,"KML","KML",1829561453),expr__14656))){
...
cesium.client.azimuths_AMPERSAND_points = (function cesium$client$azimuths_AMPERSAND_points(p__14659,radr,hgt,N){
var vec__14660 = p__14659;
var c_lambda = cljs.core.nth.call(null,vec__14660,(0),null);
var c_phi = cljs.core.nth.call(null,vec__14660,(1),null);
var s = ((Math.PI * (2)) / N);
var azs = cljs.core.range.call(null,(0),(N * s),s);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [azs,cljs.core.vec.call(null,cljs.core.map.call(null,((function (s,azs,vec__14660,c_lambda,c_phi){
return (function (p1__14658_SHARP_){
return cljs.core.concat.call(null,cesium.client.position_js.call(null,c_lambda,c_phi,radr,p1__14658_SHARP_),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [hgt], null));
});})(s,azs,vec__14660,c_lambda,c_phi))
,azs))], null);
});
...
var vec__14663 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cmp__$1.longitude,cmp__$1.latitude,cmp__$1.height], null);
var lam = cljs.core.nth.call(null,vec__14663,(0),null);
var phi = cljs.core.nth.call(null,vec__14663,(1),null);
var hgt = cljs.core.nth.call(null,vec__14663,(2),null);
var az = camera.heading;
var c = ((((dist_m / (1852)) / (60)) / (180)) * Math.PI);
var vec__14666 = cesium.client.position_js.call(null,lam,phi,c,az);
var lam2 = cljs.core.nth.call(null,vec__14666,(0),null);
var phi2 = cljs.core.nth.call(null,vec__14666,(1),null);
...
var expr__14673 = cljs.core.deref.call(null,cesium.client.ORBIT).call(null,new cljs.core.Keyword(null,"status","status",-1997798413));
if(cljs.core.truth_(pred__14672.call(null,new cljs.core.Keyword(null,"init","init",-1875481434),expr__14673))){
...
if(cljs.core.truth_(pred__14672.call(null,new cljs.core.Keyword(null,"stop","stop",-2140911342),expr__14673))){
...
var vec__14675 = cesium.client.look_at.call(null,camera,radm);
var lam = cljs.core.nth.call(null,vec__14675,(0),null);
var phi = cljs.core.nth.call(null,vec__14675,(1),null);
var hgt = cljs.core.nth.call(null,vec__14675,(2),null);
var look = vec__14675;
var vec__14678 = cesium.client.azimuths_AMPERSAND_points.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lam,phi], null),radr,hgt,steps);
var azs = cljs.core.nth.call(null,vec__14678,(0),null);
var pts = cljs.core.nth.call(null,vec__14678,(1),null);
var ring = cljs.core.vec.call(null,cljs.core.map.call(null,((function (steps,radm,radr,vec__14675,lam,phi,hgt,look,vec__14678,azs,pts,pred__14672,expr__14673,obut){
return (function (p1__14670_SHARP_){
return Cesium.Cartesian3.fromRadians(cljs.core.first.call(null,p1__14670_SHARP_),cljs.core.second.call(null,p1__14670_SHARP_),cljs.core.nth.call(null,p1__14670_SHARP_,(2)));
});})(steps,radm,radr,vec__14675,lam,phi,hgt,look,vec__14678,azs,pts,pred__14672,expr__14673,obut))
,pts));
var headings = cljs.core.vec.call(null,cljs.core.map.call(null,((function (steps,radm,radr,vec__14675,lam,phi,hgt,look,vec__14678,azs,pts,ring,pred__14672,expr__14673,obut){
return (function (p1__14671_SHARP_){
return cesium.client.normaz.call(null,(p1__14671_SHARP_ + Math.PI));
});})(steps,radm,radr,vec__14675,lam,phi,hgt,look,vec__14678,azs,pts,ring,pred__14672,expr__14673,obut))
,azs));
...
if(cljs.core.truth_(pred__14672.call(null,new cljs.core.Keyword(null,"run","run",-1821166653),expr__14673))){
camera.cancelFlight();
