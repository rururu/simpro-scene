 ...
 * @author  ru
 */
public class MapBackObjectsMenuItem extends JMenuItem implements ActionListener {
    ...
    public MapBackObjectsMenuItem() {
        super("Map Back Objects");
        setMnemonic('M');
