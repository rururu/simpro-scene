    ...
    public static OMTText createOMTText(
        ...
        if(cls!=null){
            ...
            if(inst!=null){
                ...
                inst.setOwnSlotValue(OpenMapTab.kb.getSlot(Ontology.S_X),Integer.getInteger(x, 0));
                inst.setOwnSlotValue(OpenMapTab.kb.getSlot(Ontology.S_Y),Integer.getInteger(y, 0));
                inst.setOwnSlotValue(OpenMapTab.kb.getSlot(Ontology.S_FONT_SIZE),Integer.getInteger(fontSize, 11));
